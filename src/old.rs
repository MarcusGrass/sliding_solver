...
impl State {
    ...
    fn next_position(&self, direction: Direction) -> Option<Position> {
        ...
        // Stop the Main Piece if it hits a blocker, another piece, or the edge of the board.
        ...
        // If the Main Piece moved outside of the board, return None.
        if x < 0 || x >= 8 || y < 0 || y >= 8 {
            return None;
        }
...
fn main() {
    ...
    let pieces = vec![
        Piece::new(Position::new(3, 2), false),
        Piece::new(Position::new(1, 4), false),
        Piece::new(Position::new(0, 4), true),
    ];
